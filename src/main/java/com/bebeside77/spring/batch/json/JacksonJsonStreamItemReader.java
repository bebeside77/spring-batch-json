...
/**
 * Spring batch ItemReader to streaming read json file.
 * When read big size json file it is useful.
 *
 * @param <T>
 */
public class JacksonJsonStreamItemReader<T> extends AbstractItemStreamItemReader<T>{
